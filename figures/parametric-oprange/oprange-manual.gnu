...
set ylabel "log( normalized throughput ) - log( delay )" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ -2.00000 : -0.400000 ] noreverse nowriteback
...
ordinate = "($2)"
o = "(log($2/$1) - log($3/150))"
plot "linkspeed2x.plot" u 1:(log($2/$1) - log($3/150)), "linkspeed10x.plot" u 1:(log($2/$1) - log($3/150)), "linkspeed100x.plot" u 1:(log($2/$1) - log($3/150)), "linkspeed1000x.plot" u 1:(log($2/$1) - log($3/150)), (x>22.36)-2, (x > 44.72)-2, "linkspeedcubic.plot" u 1:(log($2/$1) - log($3/150)), "linkspeedcubicsfqCoDel.plot" u 1:(log($2/$1) - log($3/150))
#    EOF
