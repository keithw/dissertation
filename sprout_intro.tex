...
\vspace{\baselineskip}
\scriptsize\def\svgwidth{\columnwidth}\input{newfigure1.pdf_tex}
\end{figure}
...
\S\ref{s:eval}) using data collected from four different commercial
...
delay\footnote{This metric expresses a lower bound on the amount of
  ...
  signal. We define the metric more precisely in \S\ref{s:eval}.} for
